...
namespace IIS.Modul_ucheta_sroka_dejjstviya_zaklyuchennykh_dogovorov
{
    ...
    [AssociatedDetailViewAttribute("РасчетВремениE", "ОказУслуг", "ОказУслугE", true, "", "Оказание услуг", true, new string[] {
            ""})]
    ...
    public class РасчетОстВрем : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Modul_ucheta_sroka_dejjstviya_zaklyuchennykh_dogovorov.DetailArrayOfОказУслуг fОказУслуг;
        ...
        public virtual IIS.Modul_ucheta_sroka_dejjstviya_zaklyuchennykh_dogovorov.DetailArrayOfОказУслуг ОказУслуг
        {
            get
            {
                ...
                {
                    this.fОказУслуг = new IIS.Modul_ucheta_sroka_dejjstviya_zaklyuchennykh_dogovorov.DetailArrayOfОказУслуг(this);
                }
                IIS.Modul_ucheta_sroka_dejjstviya_zaklyuchennykh_dogovorov.DetailArrayOfОказУслуг result = this.fОказУслуг;

...
moduleForAcceptance('[AGAT] Acceptance | i i s modul ucheta sroka dejjstviya zaklyuchennykh dogovorov расчет ост врем l');

test('testing i-i-s-modul-ucheta-sroka-dejjstviya-zaklyuchennykh-dogovorov-расчет-ост-врем-l', function(assert) {

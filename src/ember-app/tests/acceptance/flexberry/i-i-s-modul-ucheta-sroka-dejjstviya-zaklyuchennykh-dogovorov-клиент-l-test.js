...
moduleForAcceptance('[AGAT] Acceptance | i i s modul ucheta sroka dejjstviya zaklyuchennykh dogovorov клиент l');

test('testing i-i-s-modul-ucheta-sroka-dejjstviya-zaklyuchennykh-dogovorov-клиент-l', function(assert) {
